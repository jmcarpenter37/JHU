...
/**
 * The PrinterQueue class is used to build up the printer queue
 *
...
public class PrinterQueue {
    ...
    /**
     * showPrinterQueue method loops through the LinkedList print_queue and displays all the entries in the LinkedList
     */
